...
import { editEpisode } from "modules/admin/admin-fetch";
export type EditEpisodeFields = {
  title: string;
  duration: number;
  openingStart: number;
  openingEnd: number;
    ...
    <Box width={{ md: 500, xs: 1 }}>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Stack mt={2} direction={{ md: "row", xs: "column" }} gap={2}>
          <Button fullWidth type="submit" disabled={$editEpisode.isLoading}>
            რედაქტირება
          </Button>
